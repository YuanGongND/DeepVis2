...
#%%
def loadDataDCASE4000( testTask, testFolder = 3, precision = 'original', sampleRate = 16000, dataType = 'toyWaveform' ):
    
    if dataType == 'toyWaveform':
        dataFileFolder = '../../../processedData/DCASE4000/toyWaveform/' + 'folder'
    elif dataType == 'waveform':
        dataFileFolder = '../../../processedData/DCASE4000/waveform/' + 'folder'
    elif dataType == 'toySpectrogram':
        dataFileFolder = '../../../processedData/DCASE4000/toySpectrogram/' + 'folder'
    elif dataType == 'spectrogram':
        dataFileFolder = '../../../processedData/DCASE4000/spectrogram/' + 'folder'
    ...
    if testTask == 'scene':
        trainFeature, trainLabel = processData( trainData, task = testTask, dataType = dataType, dataset = 'DCASE4000' )
        testFeature, testLabel = processData( testData, task = testTask, dataType = dataType, dataset = 'DCASE4000' ) # note: don't balance the test set
