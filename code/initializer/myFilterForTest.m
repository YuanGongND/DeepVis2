...
for range = 0.0001: up_bound/bins: up_bound

type = 'bandPass';
filter = fir1( N -1, [ range, range + up_bound/bins ], type );
...
csvwrite( [ type, 'Filters_', num2str( N ), '_', num2str( bins ), '_', num2str(up_bound *100) '.csv' ], outputFilter );
